...
|---|---|---|---|---|
|   iCON MIDIPORT V1.01  |❌ |  ⚠️ |  ⚠️ |  Max SysEx length 256 bytes |
|  MIDIPLUS MIDI 2x2 |  ⚠️ |  ⚠️ |  ⚠️ |  Max SysEx length 256 bytes |
|   PreSonus Studio 26  |  ✅ |  ✅ |  ⚠️ (512 bytes max length) | Requires driver on Windows  |
